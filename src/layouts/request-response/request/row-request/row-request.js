...
export default function RowRequest({ item }) {
                        ...
                        >
                            <View style={{ marginBottom: dimensions.moderate(3), display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between' }}>
                                ...
                                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-end' }}>
                                    ...
                                    {
                                        item[KeyGetListRequest.type] != '1' && <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginRight: dimensions.moderate(20) }}>
                                            <IconComp style={{ margin: 0, padding: 0 }} iconSize={fontSizes.small} icon_nm={'send'} iconColor={colors.BUTTON__PRIMARY}></IconComp>
                                            ...
                                            <TextComp
                                                ...
                                                numberOfLines={2}
                                                textColor={colors.TEXT__PRIMARY}
                                                value={item[KeyGetListRequest.isSendAll] == '1' ? t('sendAll') : FormatNumber(item[KeyGetListRequest.total_send] || 0, 0, '', 0, 'short')}
                                            ></TextComp>
                                        </View>
                                    }
...

                                    {
                                        item[KeyGetListRequest.type] == '1' && <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginRight: dimensions.moderate(20) }}>
                                            ...
                                            <TextComp
                                                ...
                                                numberOfLines={2}
                                                textColor={colors.TEXT__PRIMARY}
                                                value={item[KeyGetListRequest.agency_name]}
                                            ></TextComp>
                                        </View>
                                    }
                                    ...
                                    <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                        ...
                                        <TextComp
                                            ...
                                            numberOfLines={2}
                                            textColor={colors.TEXT__PRIMARY}
                                            value={FormatNumber(item[KeyGetListRequest.total_feedback] || 0, 0, '', 1, 'short')}
                                        ></TextComp>
