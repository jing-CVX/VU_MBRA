...
export default function RowDetailReceive({ item }) {
                            ...
                            <View style={{ marginBottom: dimensions.moderate(3), display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between' }}>
                                <View>
                                    <View style={{ display: 'flex', flexDirection: 'row', marginBottom: dimensions.vertical(5) }}>
                                        <View >
                                            <TextComp
                                                ...
                                                value={(item[KeyGetListFeedback.title] || '')}
                                            ></TextComp>
                                        </View>
                                    </View>
                                    <View style={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'row', marginBottom: dimensions.vertical(5) }}>
                                        <View style={{ display: 'flex', flexDirection: 'row', marginBottom: dimensions.vertical(5) }}>
                                            ...
                                            <TextComp
                                                ...
                                                fontWeight={fontWeights.bold}
                                                textColor={colors.TEXT__SECONDARY}
                                                value={item[KeyGetListFeedback.create_user_name]}
                                            ></TextComp>
                                        </View>
                                        <View style={{ display: 'flex', flexDirection: 'row', marginBottom: dimensions.vertical(5) }}>
                                            ...
                                            <TextComp
                                                ...
                                                fontWeight={fontWeights.bold}
                                                textColor={colors.TEXT__SECONDARY}
                                                value={`${moment(item[KeyGetListFeedback.create_time], 'YYYYMMDDHHmmss').format('DD/MM/YYYY HH:mm')}`}
                                            ></TextComp>
                                        </View>
                                    </View>
                                    ...
                                    <View style={{ display: 'flex', flexDirection: 'column', marginBottom: dimensions.vertical(5) }}>
                                        <TextComp
                                            ...
                                            numberOfLines={2}
                                            textColor={colors.TEXT__SECONDARY}
                                            value={item[KeyGetListFeedback.content]}
                                        ></TextComp>
                                    </View>
                                </View>
                                ...
                                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-end' }}>

                                    {
                                        ...
                                        item[KeyGetListFeedback.list_file].length > 0 && <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                            ...
                                            <TextComp
                                                ...
                                                value={'File: ' + item[KeyGetListFeedback.list_file].length || 0}
                                            ></TextComp>
...
const styles = StyleSheet.create({
    ...
    item_box_touchable: {
        ...
        display: "flex",
        position: "relative",
        borderTopWidth: dimensions.vertical(1),
    },
});
