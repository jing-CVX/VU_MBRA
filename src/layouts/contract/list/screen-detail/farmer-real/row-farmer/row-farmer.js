...
import { KeyGetListActualFarming } from "../../../../../../utils/constant/key";


export default function RowFarmer({ item }) {
                                ...
                                <View style={{ display: 'flex', flexDirection: 'row', marginBottom: dimensions.vertical(5) }}>
                                    ...
                                    <View style={{ padding: dimensions.moderate(5), display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                        <TextComp
                                            ...
                                            value={item[KeyGetListActualFarming.farmer_name]}
                                        ></TextComp>
                                    </View>
                                </View>
                                ...
                                <View style={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'row', marginBottom: dimensions.vertical(5) }}>
                                   ...
                                   <View style={{ display: 'flex', flexDirection: 'row', marginBottom: dimensions.vertical(5) }}>
                                       ...
                                       <TextComp
                                           ...
                                           fontWeight={fontWeights.bold}
                                           textColor={colors.TEXT__SECONDARY}
                                           value={`${FormatNumber(item[KeyGetListActualFarming.acreage])}(${item[KeyGetListActualFarming.caculate_unit] === "1" ? "ha" : "m²"})`}
                                       ></TextComp>
                                   </View>
                               </View>
                                <View style={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'row', marginBottom: dimensions.vertical(5) }}>
                                    <View style={{ display: 'flex', flexDirection: 'row', marginBottom: dimensions.vertical(5) }}>
                                        ...
                                        <TextComp
                                            ...
                                            fontWeight={fontWeights.bold}
                                            textColor={colors.TEXT__PRIMARY}
                                            value={item[KeyGetListActualFarming.note] ||''}
                                        ></TextComp>
                                    </View>
