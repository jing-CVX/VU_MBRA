...
export function ModalEnterExperian({
    visibleModal,
    closeModal,
    poDetail,
    poDetailId,
            ...
            <View style={styles.cardModal}>
                <View>
                    <View style={styles.cardHeader}>
                        ...
                        >
                            <TextComp
                                value={`${t('add_experian')} - ${t('step')}: ${stepCode}`}
                ...
                <ScrollView style={{ margin: dimensions.moderate(10), zIndex: 999999999 }}>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-end' }}>
                        <View style={{ flex: 1, marginRight: dimensions.moderate(5) }}>
                            <ButtonComp
                                icon_name={''}
                                buttonColor={color.LIGHT.BLUE__BG__COLOR}
                                mode="text"
                                onPress={() => {
                    ...
                    <View style={{
                        ...
                        <View style={{ marginLeft: dimensions.moderate(5), flex: 1 }}>
                            <ButtonComp
                                icon_name={''}
                                buttonColor={color.LIGHT.ORANGE_1}
                                mode="text"
                                onPress={() => {
                                    if (!addKey) return;
                                    setKey(`${!key.length ? '' : key + ', '}${addKey}`);
                                    ...
                                    key.split(',').map((word, indexKey) => {
                                        return <View key={indexKey} style={{ marginLeft: dimensions.moderate(5), marginBottom: dimensions.vertical(5) }}>
                                            ...
                                            <ButtonComp
                                                ...
                                                buttonColor={color.LIGHT.ORANGE_2}
                                                mode="text"
                                                onPress={() => {
